...
function gutenberg_register_vendor_scripts() {
	...
	gutenberg_register_vendor_script(
		'react',
		'https://unpkg.com/react@16.3.0-rc.0/umd/react' . $react_suffix . '.js'
	);
	gutenberg_register_vendor_script(
		'react-dom',
		'https://unpkg.com/react-dom@16.3.0-rc.0/umd/react-dom' . $react_suffix . '.js',
		array( 'react' )
	);
	gutenberg_register_vendor_script(
		'react-dom-server',
		'https://unpkg.com/react-dom@16.3.0-rc.0/umd/react-dom-server.browser' . $react_suffix . '.js',
		array( 'react' )
	);
